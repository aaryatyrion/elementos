...
public class MainView extends View {
    ...
    public MainView(Context context) {
        ...
        try {
            ...
            // this.setBackgroundColor(getResources().getColor(R.color.cardViewBackground));
            this.setBackgroundResource(R.drawable.bg20);
    ...
    private void drawCellText(Canvas canvas, int value) {
        ...
        Log.i("DRAW_CELL_TEXT ", value+"");
        canvas.drawText(DataUtils.getElementByAtomicNumber(log2(value)), cellSize / 2, cellSize / 2 - textShiftY, paint);
    }
